...
const TeamPage = () => {
  ...
  return (
    ...
    <div className='max-w-5xl pt-28 pb-16 md:pt-52 px-4 lg:px-8'>
        <h1 className='text-4xl lg:text-6xl'>Powered by <HighlightWord info={about_content.tech_stack[0]}/>, <HighlightWord info={about_content.tech_stack[1]}/> and <HighlightWord info={about_content.tech_stack[2]}/>.</h1>
    </div>
...
const HighlightWord: React.FC<HighlightWordInterface> = ({ info }) => {
  return <Link href={info.href}><strong>{info.name}</strong></Link>;
};
