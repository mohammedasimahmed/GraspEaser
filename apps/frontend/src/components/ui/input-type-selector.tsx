"use client";
import { inputTypeAtom, InputTypes, InputTypesArray } from '@/atoms/user-input';
            ...
            return (
              <div key={index}>
                {inputType === value ?
                  ...
                  <span className=' border-gray-400 px-2 py-1 text-gray-400 cursor-pointer' onClick={() => setInputType(value)}>{input_type}</span>
                }
              </div>
            )
          })
