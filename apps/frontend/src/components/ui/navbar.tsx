    ...
    <>
      <nav className="w-full fixed top-0 z-20 backdrop-blur-2xl px-6 py-3">
        <div className="w-full flex items-center justify-between">
          <Link href="/">
            <div className="text-2xl lg:text-3xl font-semibold">GraspEaser</div>
          </Link>
          {/* Desktop View */}
          <div className="hidden md:flex flex-1 gap-6 mx-3 justify-center items-center">
            <Link href="/" className="mr-2 text-lg">
              Home
            </Link>
            <Link href="/about" className="mr-2 text-lg">
              About
            </Link>
            <Link href="/easer" className="text-lg">
              Easer
            </Link>
          ...
          <div className="hidden md:flex">
            {username ? (
              <>
                <div className="mr-2 flex justify-center items-center text-xl">
                  {username}
                </div>
        ...
        {isNavbarOpen && (
          <div className="md:hidden text-black flex flex-col items-center py-3 mt-3">
            <Link href="/" className="mb-2 text-xl" onClick={toggleNavbar}>
              Home
            </Link>
            <Link href="/about" className="mb-2 text-xl" onClick={toggleNavbar}>
              About
            </Link>
            <Link href="/easer" className="mb-2 text-xl" onClick={toggleNavbar}>
              Easer
            </Link>
            <Link href="/terms" className="mb-2 text-xl" onClick={toggleNavbar}>
              Terms
            </Link>
            {username ? (
              <>
